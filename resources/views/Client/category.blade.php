                        ...
                        <div class="properties__button">
                            ...
                            <nav>                                                                     
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link {{ !$slug ? 'active' : '' }}" href="{{ route('category.index') }}">All</a>
                                    @foreach($categories as $category)
                                        <a class="nav-item nav-link {{ $slug == $category->slug ? 'active' : '' }}" href="{{ route('category.index', $category->slug) }}">{{ $category->name }}</a>
                                    @endforeach
                                </div>
                            </nav>
                            <!--End Nav Button  -->
